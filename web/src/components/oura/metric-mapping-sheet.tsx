...
const OURA_METRICS = [
  ...
  { id: "sleep_efficiency", name: "Sleep Efficiency", category: "Sleep", unit: "%" },
  ...
  { id: "resting_heart_rate", name: "Resting Heart Rate", category: "Sleep", unit: "bpm" },
  { id: "hrv_average", name: "HRV Average", category: "Sleep", unit: "ms" },
  { id: "readiness_score", name: "Readiness Score", category: "Readiness", unit: "0–100" },
  { id: "activity_score", name: "Activity Score", category: "Activity", unit: "0–100" },
